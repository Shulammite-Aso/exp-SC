...
import { SidebarContent } from './components/SidebarContent/Loadable';
...
import { productCategorySelector } from '../../../pages/product/slice/selectors';
...
export const Sidebar = memo((props: Props) => {
  ...
  const selectOption = id => {
    ...
    const filtered: any = categories?.filter(cat => cat.id === id);
